...
import org.serratec.api.EcommercApi.service.ClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<Void> atualizar(@PathVariable Integer idCliente,@RequestBody ClienteDTO clienteDTO) throws ClienteException{
